import{_wcl}from"./common-lib.js";import{_wccss}from"./common-css.js";import{colorPalette as _fujiColorPalette,input as _fujiInput,buttons as _fujiButtons}from"./fuji-css.js";import Mustache from"./mustache.js";import"https://unpkg.com/yahoo-pixelframe-uploader/mjs/wc-yahoo-pixelframe-uploader.js";import"https://unpkg.com/msc-dialogs/mjs/wc-msc-dialogs.js";import"https://unpkg.com/msc-circle-progress/mjs/wc-msc-circle-progress.js";import"https://unpkg.com/msc-lightbox/mjs/wc-msc-lightbox.js";const blankImage="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==",defaults={maxpickcount:1,maxuploadcount:100,placeholder:"Search video",uploader:{multiple:!0,accept:".mov,.mp4,.ogg,.webm",imagelimitation:{minwidth:100,minheight:100,size:52428800},videolimitation:{minwidth:100,minheight:100,size:314572800,duration:3600},maximagecount:0,maxvideocount:20,webservice:{token:{url:"https://trendr-apac.media.yahoo.com/api/pixelframe/v1/aws/resources/s3/credentials?role=content-upload"},upload:{urls:{video:"https://trendr-apac.media.yahoo.com/api/pixelframe/v1/videos/upload",image:"https://trendr-apac.media.yahoo.com/api/pixelframe/v1/images/upload"},params:{targetType:"videolibrary",targetId:"auction2",appName:"auction",resizingProfile:"auction",transcodingProfile:"auction"}}}},webservice:{listings:"https://tw.bid.yahoo.com/api/reeldeal/v1/me/videos?status=ACTIVE&&offset=0&limit=100",create:"https://tw.bid.yahoo.com/api/reeldeal/v1/videos",edit:"https://tw.bid.yahoo.com/api/reeldeal/v1/videos/{{videoId}}",delete:"https://tw.bid.yahoo.com/api/reeldeal/v1/videos/{{videoId}}"}},booleanAttrs=[],objectAttrs=["uploader"],custumEvents={pick:"yahoo-pixelframe-drive-pick",delete:"yahoo-pixelframe-drive-delete",error:"yahoo-pixelframe-drive-error"},isSafari=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),template=document.createElement("template"),templateUnit=(template.innerHTML=`
<style>
${_wccss}
${_fujiColorPalette}
${_fujiInput}
...
{{/units}}
`,CSS?.registerProperty)try{CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-inline-size",syntax:"<length>",inherits:!0,initialValue:"800px"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-dialog-background-color",syntax:"<color>",inherits:!0,initialValue:"rgba(255 255 255)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-dialog-title-color",syntax:"<color>",inherits:!0,initialValue:"rgba(70 78 86)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-dialog-title-border-color",syntax:"<color>",inherits:!0,initialValue:"rgba(130 138 147)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-hr-color",syntax:"<color>",inherits:!0,initialValue:"rgba(224 228 233)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-no-result-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(70 78 86)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-normal-background-color",syntax:"<color>",inherits:!0,initialValue:"rgba(240 243 245)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-active-background-color",syntax:"<color>",inherits:!0,initialValue:"rgba(224 228 233)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-input-color",syntax:"<color>",inherits:!0,initialValue:"rgba(35 42 49)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-input-placeholder-color",syntax:"<color>",inherits:!0,initialValue:"rgba(151 158 168)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-icon-color",syntax:"<color>",inherits:!0,initialValue:"rgba(35 42 49)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-search-border-color",syntax:"<color>",inherits:!0,initialValue:"rgba(199 205 210)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-listing-border-color",syntax:"<color>",inherits:!0,initialValue:"rgba(224 228 233)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-listing-overlay-background",syntax:"<color>",inherits:!0,initialValue:"rgba(255 255 255/.35)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-pick-info-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(35 42 49)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-action-button-accent-color",syntax:"<color>",inherits:!0,initialValue:"rgba(15 105 255)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-action-button-inert-color",syntax:"<color>",inherits:!0,initialValue:"rgba(176 185 193)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-add-button-icon-color",syntax:"<color>",inherits:!0,initialValue:"rgba(230 50 89)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-add-button-icon-inert-color",syntax:"<color>",inherits:!0,initialValue:"rgba(176 185 193)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drive-add-button-active-background-color",syntax:"<color>",inherits:!0,initialValue:"rgba(242 242 242)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-delete-title-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(35 42 49)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-delete-description-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(176 185 193)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-background-color",syntax:"<color>",inherits:!0,initialValue:"rgba(255 255 255)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(35 42 49)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-border-color",syntax:"<color>",inherits:!0,initialValue:"rgba(110 119 128)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-placeholder-color",syntax:"<color>",inherits:!0,initialValue:"rgba(70 78 86)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-label-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(110 119 128)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-edit-input-theme-color",syntax:"<color>",inherits:!0,initialValue:"rgba(15 105 255)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drag-n-drop-hint-text-color",syntax:"<color>",inherits:!0,initialValue:"rgba(255 255 255)"}),CSS.registerProperty({name:"--yahoo-pixelframe-drive-drag-n-drop-hint-overlay-color",syntax:"<color>",inherits:!0,initialValue:"rgba(0 0 0/.8)"})}catch(e){console.warn("yahoo-pixelframe-drive: "+e.message)}class YahooPixelframeDrive extends HTMLElement{#data;#nodes;#config;constructor(e){super(),this.attachShadow({mode:"open",delegatesFocus:!0}),this.shadowRoot.appendChild(template.content.cloneNode(!0)),this.#data={controller:"",dragCount:0,listingsFetched:!1,listings:{},orders:[]},this.#nodes={styleSheet:this.shadowRoot.querySelector("style"),main:this.shadowRoot.querySelector(".main"),uploader:this.shadowRoot.querySelector("yahoo-pixelframe-uploader"),dialogDrive:this.shadowRoot.querySelector(".dialog-drive"),dialogEdit:this.shadowRoot.querySelector(".dialog-edit"),dialogDelete:this.shadowRoot.querySelector(".dialog-delete"),drive:this.shadowRoot.querySelector(".dialog-drive .drive"),formDriveMain:this.shadowRoot.querySelector(".dialog-drive .drive__main"),formSearch:this.shadowRoot.querySelector(".drive__search__form"),formEdit:this.shadowRoot.querySelector(".dialog-edit .video-dialog"),formDelete:this.shadowRoot.querySelector(".dialog-delete .video-dialog"),gallery:this.shadowRoot.querySelector(".drive__gallery"),btnPick:this.shadowRoot.querySelector(".dialog-drive .drive__main .buttons"),infoMaxPickCount:this.shadowRoot.querySelector(".drive__main__action__info__maxpickcount"),infoPickCount:this.shadowRoot.querySelector(".drive__main__action__info__pickcount"),lightbox:this.shadowRoot.querySelector("msc-lightbox"),preview:this.shadowRoot.querySelector(".lightbox-content")},this.#config={...defaults,...e},this._uploaderHandler=this._uploaderHandler.bind(this),this._onGalleryClick=this._onGalleryClick.bind(this),this._onAnimationEnd=this._onAnimationEnd.bind(this),this._onDialogsClose=this._onDialogsClose.bind(this),this._editHandler=this._editHandler.bind(this),this._deleteHandler=this._deleteHandler.bind(this),this._onPick=this._onPick.bind(this),this._onSubmit=this._onSubmit.bind(this),this._onSearchInput=this._onSearchInput.bind(this),this._onLightboxToggle=this._onLightboxToggle.bind(this),this._onDnD=this._onDnD.bind(this),this._hintHandler=this._hintHandler.bind(this)}async connectedCallback(){var{config:e,error:t}=await _wcl.getWCConfig(this);const{main:i,uploader:a,gallery:o,formDriveMain:r,formSearch:n,formEdit:s,formDelete:l,drive:c,lightbox:d}=this.#nodes;if(t)console.warn(_wcl.classToTagName(this.constructor.name)+": "+t),this.remove();else{this.#config={...this.#config,...e},Object.keys(defaults).forEach(e=>this.#upgradeProperty(e)),this.#data.controller=new AbortController;const p=this.#data.controller.signal;t=customElements.get("yahoo-pixelframe-uploader")["supportedEvents"],e=(o.addEventListener("click",this._onGalleryClick,{signal:p}),o.addEventListener("animationend",this._onAnimationEnd,{signal:p}),r.addEventListener("input",this._onPick,{signal:p}),r.addEventListener("submit",this._onSubmit,{signal:p}),n.addEventListener("input",this._onSearchInput,{signal:p}),s.addEventListener("submit",this._editHandler,{signal:p}),s.addEventListener("input",this._editHandler,{signal:p}),l.addEventListener("submit",this._deleteHandler,{signal:p}),i.addEventListener("msc-dialogs-close",this._onDialogsClose,{signal:p}),d.addEventListener("msc-lightbox-toggle",this._onLightboxToggle,{signal:p}),t.forEach(e=>{a.addEventListener(e,this._uploaderHandler,{signal:p})}),["dragover","drop","paste"].forEach(e=>{c.addEventListener(e,this._onDnD,{signal:p,capture:!0})}),["dragover","dragleave"]);isSafari&&e.push("dragenter"),e.forEach(e=>{document.body.addEventListener(e,this._hintHandler,{signal:p,capture:!0})}),this.#buildStage()}}disconnectedCallback(){this.#data?.controller&&this.#data.controller.abort()}#format(i,e,a){if(null!==a)switch(i){case"placeholder":this.#config[i]=a.trim()||defaults[i];break;case"maxuploadcount":case"maxpickcount":var t=+a;this.#config[i]=isNaN(t)||t<0?defaults[i]:t;break;case"webservice":{let e={};try{e=JSON.parse(a)}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e.message)}this.#config[i]={...defaults[i],...e};break}case"uploader":{let t;try{t=JSON.parse(a)}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e.message),t=Array.isArray(defaults[i])?[...defaults[i]]:{...defaults[i]}}this.#config[i]={...defaults[i],...t};break}}else booleanAttrs.includes(i)?this.#config[i]=!1:this.#config[i]=defaults[i]}attributeChangedCallback(e,t,i){if(YahooPixelframeDrive.observedAttributes.includes(e))switch(this.#format(e,t,i),e){case"uploader":Object.keys(this.uploader).forEach(e=>{this.#nodes.uploader[e]=this.uploader[e]});break;case"maxpickcount":this.#nodes.infoMaxPickCount.textContent=this.maxpickcount;break;case"placeholder":this.#nodes.formSearch.querySelector("input[type=search]").placeholder=this.placeholder}}static get observedAttributes(){return Object.keys(defaults)}static get supportedEvents(){return Object.keys(custumEvents).map(e=>custumEvents[e])}#upgradeProperty(e){let t;YahooPixelframeDrive.observedAttributes.includes(e)&&(Object.prototype.hasOwnProperty.call(this,e)?(t=this[e],delete this[e]):t=booleanAttrs.includes(e)?!(!this.hasAttribute(e)&&!this.#config[e]):objectAttrs.includes(e)?this.hasAttribute(e)?this.getAttribute(e):JSON.stringify(this.#config[e]):this.hasAttribute(e)?this.getAttribute(e):this.#config[e],this[e]=t)}set maxuploadcount(e){void 0!==e?this.setAttribute("maxuploadcount",e):this.removeAttribute("maxuploadcount")}get maxuploadcount(){return this.#config.maxuploadcount}set maxpickcount(e){void 0!==e?this.setAttribute("maxpickcount",e):this.removeAttribute("maxpickcount")}get maxpickcount(){return this.#config.maxpickcount}set placeholder(e){void 0!==e?this.setAttribute("placeholder",e):this.removeAttribute("placeholder")}get placeholder(){return this.#config.placeholder}set uploader(e){e?(e={...defaults.uploader,...this.uploader,..."string"==typeof e?JSON.parse(e):e},this.setAttribute("uploader",JSON.stringify(e))):this.removeAttribute("uploader")}get uploader(){return this.#config.uploader}set webservice(e){e?(e={...defaults.webservice,...this.webservice,..."string"==typeof e?JSON.parse(e):e},this.setAttribute("webservice",JSON.stringify(e))):this.removeAttribute("webservice")}get webservice(){return this.#config.webservice}get open(){return this.#nodes.dialogDrive.open}#fireEvent(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,...t&&{detail:t}}))}#decorateDialog({action:e,data:t}){var{id:t,name:i,description:a,thumbnail:o}=t,r=this.#nodes["dialog"+_wcl.capitalize(e)],n=r.querySelector("[data-ref=id]"),s=r.querySelector("[data-ref=image]"),l=r.querySelector("[data-ref=name]"),c=r.querySelector("[data-ref=description]");return n.value=t,s.src=o,l["edit"===e?"value":"textContent"]=i,c["edit"===e?"value":"textContent"]=a,r}#getUnitId(){return"unit-"+_wcl.getUUID()}async#buildStage(){var t=this.#data["listingsFetched"],e=this.#nodes["gallery"];if(!t){this.#data.listingsFetched=!0;try{this.#data.listings=[],this.#data.orders=[];const r=[];var i,{videos:a=[]}=await this.#fetchListings();a.forEach(e=>{var t=this.#getUnitId(),{title:i="",description:a="",thumbnail:{url:o=""}={}}=e;r.push({id:t,thumbnail:o,status:"done",freeze:!1}),this.#data.listings[t]={id:t,type:"video",thumbnail:o,name:i,duration:3600,status:"done",description:a,result:e},this.#data.orders.unshift(t)}),a.length&&(i=Mustache.render(templateUnit.innerHTML,{units:r}),e.insertAdjacentHTML("afterbegin",i))}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e);var{message:t,cause:a}=e;this.#fireEvent(custumEvents.error,{message:t,...a&&{cause:a}})}}}_onGalleryClick(e){var e=e["target"],t=e.closest("button");if(t){var i,{id:e,status:a}=e.closest("[data-id]").dataset,t=t.dataset.action,o=this.#data.listings[e];if(o){if("error"!==a||"delete"!==t)return"preview"===t?({result:{resizeVideos:a=[],url:i=""}={}}=o,(a=a?.[0]?.url||i)?(this.#nodes.preview.src=a,void this.#nodes.lightbox.showPopover()):void 0):void this.#decorateDialog({action:t,data:o}).showModal();this.#deleteUnit(e)}}}#deleteUnit(t){var e=this.#data.orders.findIndex(e=>e===t),i=this.#nodes.gallery.querySelector(`[data-id=${t}]`);-1!=e&&this.#data.orders.splice(e,1),this.#data.listings[t]&&delete this.#data.listings[t],i&&i.classList.add("drive__gallery__unit--remove")}_onAnimationEnd(e){var{animationName:e,target:t}=e;"animate-remove-gallery-unit"===e&&(t.remove(),this.#data.orders.length||this.#nodes.gallery.replaceChildren(),this.#checkBtnPick(),this.#checkUploadCount())}async#fetchListings(){var e=this.webservice["listings"],t=/^http(s)?:\/\/.*/.test(e)?void 0:window.location.origin;const i=new window.URL(e,t),a={includeVideoMetadata:!0,offset:0,limit:100};return Object.keys(a).forEach(e=>i.searchParams.set(e,a[e])),fetch(i.toString(),{headers:{"content-type":"application/json"},credentials:"include",method:"GET",mode:"cors"}).then(async t=>{if(t.ok)return t.json();{var i=t.headers.get("content-type");let e="";throw e=i&&i.includes("application/json")?await t.json():await t.text(),new Error("Network response was not OK.",{cause:e})}})}async#fetchVideoCreate(e){var t=this.webservice["create"],i=/^http(s)?:\/\/.*/.test(t)?void 0:window.location.origin,t=new window.URL(t,i);return fetch(t.toString(),{headers:{"content-type":"application/json"},credentials:"include",method:"POST",mode:"cors",body:JSON.stringify(e)}).then(async t=>{if(t.ok)return t.json();{var i=t.headers.get("content-type");let e="";throw e=i&&i.includes("application/json")?await t.json():await t.text(),new Error("Network response was not OK.",{cause:e})}})}async#fetchVideoEdit({videoId:e,title:t,description:i=""}){var a=this.webservice["edit"],a=a.replace(/\{\{videoId\}\}/,e),e=/^http(s)?:\/\/.*/.test(a)?void 0:window.location.origin,a=new window.URL(a,e),e={title:t,description:i};return fetch(a.toString(),{headers:{"content-type":"application/json"},credentials:"include",method:"PUT",mode:"cors",body:JSON.stringify(e)}).then(async t=>{if(t.ok)return t.json();{var i=t.headers.get("content-type");let e="";throw e=i&&i.includes("application/json")?await t.json():await t.text(),new Error("Network response was not OK.",{cause:e})}})}async#fetchVideoDelete({videoId:e}){var e=this.webservice.delete.replace(/\{\{videoId\}\}/,e),t=/^http(s)?:\/\/.*/.test(e)?void 0:window.location.origin,e=new window.URL(e,t);return fetch(e.toString(),{headers:{"content-type":"application/json"},credentials:"include",method:"DELETE",mode:"cors"}).then(async t=>{if(t.ok)return 204===t.status||await t.json();{var i=t.headers.get("content-type");let e="";throw e=i&&i.includes("application/json")?await t.json():await t.text(),new Error("Network response was not OK.",{cause:e})}})}_uploaderHandler(e){var t=e["type"];const{uploader:i,gallery:r}=this.#nodes;switch(t){case"yahoo-pixelframe-uploader-process-start":i.inert=!0;break;case"yahoo-pixelframe-uploader-process-end":i.inert=!1;break;case"yahoo-pixelframe-uploader-done":var a=e.detail["results"];a.forEach(async t=>{var{result:t,name:i,id:a}=t;if(this.#data.listings[a]&&t)try{var o=t["id"];await this.#fetchVideoCreate({videoId:o,title:i}),this.#data.listings[a].result={...t}}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e);var{message:o,cause:i}=e,t=(this.#fireEvent(custumEvents.error,{message:o,...i&&{cause:i}}),r.querySelector(`[data-id=${a}]`));t&&(this.#data.listings[a].status="error",t.dataset.status="error",t.querySelector("input").disabled=!0)}}),this.#checkUploadCount();break;case"yahoo-pixelframe-uploader-pick":{var{picked:a=[]}=e.detail;const l=[],c=[];a.forEach(e=>{var{id:t,thumbnail:i}=e;c.push(t),l.push({id:t,thumbnail:i,status:"processing",freeze:!0}),this.#data.listings[t]={...e,status:"processing",description:""}}),this.#data.orders=[...c,...this.#data.orders];a=Mustache.render(templateUnit.innerHTML,{units:l});r.insertAdjacentHTML("afterbegin",a);break}case"yahoo-pixelframe-uploader-progress":var{id:a,progress:o}=e.detail,n=r.querySelector(`[data-id=${a}]`),s=r.querySelector(`[data-id=${a}] msc-circle-progress`);n&&s&&100===(s.value=o)&&(this.#data.listings[a].status="done",n.dataset.status="done",n.querySelector("input").disabled=!1);break;case"yahoo-pixelframe-uploader-error":s=e.detail["id"],o=r.querySelector(`[data-id=${s}]`);o&&(this.#data.listings[s].status="error",o.dataset.status="error",o.querySelector("input").disabled=!0)}}#resetForm(e){var t=e.className.replace(/.*-(.*)/,"$1"),e=e.querySelector("form");this.#decorateDialog({action:t,data:{id:"",name:"",description:"",thumbnail:blankImage}}),this.#clearInvalid(e)}_onDialogsClose(e){e=e.target;const t=e.closest("msc-dialogs");switch(e.className.replace(/.*-(.*)/,"$1")){case"drive":var{dialogEdit:i,dialogDelete:a,lightbox:o}=this.#nodes;i.open&&i.close(),a.open&&a.close(),o.open&&o.hidePopover();break;case"delete":case"edit":setTimeout(()=>{this.#resetForm(t)},400)}}#clearInvalid(e){Array.from(e.querySelectorAll(".input-set__em")).forEach(e=>e.textContent="")}#getWarnElement(e){return e.closest(".input-set").querySelector(".input-set__em")}async _editHandler(e){e.preventDefault();var{type:e,target:t,submitter:i}=e,{dialogEdit:a,formEdit:o}=this.#nodes,r="Input title please.";switch(e){case"input":var n=t.closest("input,textarea"),s=this.#getWarnElement(n),l=!!n.value.trim().length;"name"===n.dataset.ref&&(s.textContent=l?"":r);break;case"submit":if(this.#clearInvalid(o),"cancel"===i.value)a.close();else{n=new FormData(o),s=Object.fromEntries(n.entries());if(!!s.title.trim().length){l=s.id;if(this.#data.listings[l])try{var c=this.#data.listings[l]?.result?.id,d=s.title.trim(),p=s.description.trim();await this.#fetchVideoEdit({videoId:c,title:d,description:p}),this.#data.listings[l]={...this.#data.listings[l],name:d,description:p}}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e);var{message:n,cause:s}=e;this.#fireEvent(custumEvents.error,{message:n,...s&&{cause:s}})}a.close()}else this.#getWarnElement(o.querySelector("[data-ref=name]")).textContent=r}}}async _deleteHandler(e){e.preventDefault();var e=e["submitter"],{dialogDelete:t,formDelete:i}=this.#nodes,i=new FormData(i),a=Object.fromEntries(i.entries())["id"];switch(e.value){case"cancel":t.close();break;case"submit":try{var{result:o={},name:r="",description:n=""}=this.#data.listings[a]??{},s=o["id"];await this.#fetchVideoDelete({videoId:s}),this.#deleteUnit(a),this.#fireEvent(custumEvents.delete,{title:r,description:n,...window.structuredClone(o)})}catch(e){console.warn(_wcl.classToTagName(this.constructor.name)+": "+e);var{message:s,cause:r}=e;this.#fireEvent(custumEvents.error,{message:s,...r&&{cause:r}})}t.close()}}_onSearchInput(){var{formSearch:e,infoPickCount:t,gallery:i}=this.#nodes,e=new FormData(e);const a=Object.fromEntries(e.entries()).q.toLowerCase().trim(),o=!a.length;e=this.#data.orders.reduce((e,t)=>{var i,t=this.#data.listings[t];return t?(i=t["status"],e.concat({...t,freeze:"done"!==i})):e},[]),i.replaceChildren(),e=e.filter(({name:e,description:t})=>o||e.toLowerCase().includes(a)||t.toLowerCase().includes(a));e.length&&(e=Mustache.render(templateUnit.innerHTML,{units:e}),i.insertAdjacentHTML("afterbegin",e)),t.textContent=0,this.#checkBtnPick()}_onLightboxToggle(e){var{newState:e=""}=e.detail||{},t=this.#nodes["preview"];"open"===e?t.play():t.pause()}_onSubmit(e){e.preventDefault();var e=this.#nodes["formDriveMain"],e=new FormData(e).getAll("pickedVideoIds");e.length&&(e=e.reduce((e,t)=>{var{result:t,name:i="",description:a=""}=this.#data.listings?.[t]||{};return t?e.concat({title:i,description:a,...window.structuredClone(t)}):e},[]),this.#fireEvent(custumEvents.pick,{picked:e}),this.close())}_onPick(e){var e=e.target.closest("input"),{formDriveMain:t,infoPickCount:i}=this.#nodes;let a=new FormData(t).getAll("pickedVideoIds").length;a>this.maxpickcount&&(e.checked=!1,a--),i.textContent=a,this.#checkBtnPick()}#checkBtnPick(){var{formDriveMain:e,btnPick:t}=this.#nodes,e=new FormData(e).getAll("pickedVideoIds");t.inert=!(0<e.length)}#checkUploadCount(){var{uploader:e,gallery:t}=this.#nodes,t=Array.from(t.querySelectorAll("[data-status=done]")).length;e.inert=t>this.maxuploadcount}_onDnD(e){var t=e["type"],{drive:i,uploader:a}=this.#nodes;switch(t){case"dragover":e.preventDefault();break;case"drop":var o=e["dataTransfer"];if(e.preventDefault(),this.#data.dragCount=0,a.inert)return;i.classList.toggle("drive--over",!1),a.passFiles(o.files);break;case"paste":o=e.clipboardData||window.clipboardData;document.body.focus(),a.inert||a.passFiles(o.files)}}_hintHandler(e){var e=e["type"],{drive:t,uploader:i}=this.#nodes;switch(e){case"dragenter":this.#data.dragCount++;case"dragover":this.open&&!i.inert&&t.classList.toggle("drive--over",!0);break;case"dragleave":(!isSafari||(this.#data.dragCount--,0===this.#data.dragCount))&&t.classList.toggle("drive--over",!1)}}close(){this.#nodes.dialogDrive.close()}showModal(){this.#nodes.dialogDrive.showModal()}}const S=_wcl.supports(),T=_wcl.classToTagName("YahooPixelframeDrive");S.customElements&&S.shadowDOM&&S.template&&!window.customElements.get(T)&&window.customElements.define(_wcl.classToTagName("YahooPixelframeDrive"),YahooPixelframeDrive);export{YahooPixelframeDrive};